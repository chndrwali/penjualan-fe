...
import OrderSuccessMessage from "./OrderSuccesMessage";
import { HomeContext } from "./";
import { sliderImages } from "../../Dashboard/dashboardAdmin/action";
        ...
        {data?.sliderImages?.length > 0 ? (
          <>
            ...
            <svg
              ...
              className={`z-10 absolute top-0 right-0 mt-64 items-center box-border flex justify-center w-12 h-12 text-gray-700 cursor-pointer hover:text-yellow-700`}
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
